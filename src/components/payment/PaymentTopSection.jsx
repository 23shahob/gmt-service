...
const PaymentTopSection = () => {
  return (
    <div className="mx-auto max-w-[1440px] px-4 md:px-5 lg:px-4">
      <h1 className="mb-5 text-[28px] font-medium leading-[105%] md:text-[34px] md:leading-[110%] lg:mb-10 lg:text-5xl">
        Оплата
      </h1>
      ...
      <div className="grid grid-cols-1 gap-[10px] md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-[10px] border border-[#E5E2EE] bg-white p-4 md:col-span-2 md:p-5 lg:col-span-1 lg:p-[30px]">
          <h3 className="text-base font-semibold leading-[134%] lg:text-lg lg:leading-normal">
...
export default PaymentTopSection;
