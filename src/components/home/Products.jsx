      ...
      <div>
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex gap-[10px]">
            <Link to="#">
              <button className="hidden rounded-[50px] border border-[#D5D1E1] px-2 py-1 text-[12px] text-[#088269] outline-none transition duration-300 ease-in-out hover:border-[#088269] focus:outline-none sm:block sm:px-5 sm:py-2 lg:px-[30px] lg:py-[11px] lg:text-sm">
                Бесплатная консультация
              </button>
            </Link>
            <Link to="/catalog">
              <button className="rounded-[50px] bg-[#088269] px-5 py-2 text-[12px] text-[#F8F7F3] outline-none transition duration-300 ease-in-out hover:bg-[#07745E] focus:outline-none lg:px-[30px] lg:py-[11px] lg:text-sm">
                Все товары
              </button>
            </Link>
          </div>
