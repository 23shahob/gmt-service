...
import PartnerImg from "../../assets/images/png/partner_img.png";

const PartnerSection = () => {
  return (
    <div className="bg-[#088269]">
      <div className="mx-auto max-w-[1440px] px-4 py-12 md:px-5 lg:flex lg:gap-14 lg:px-4 lg:py-20">
        ...
        <div className="md:w-3/4 lg:w-1/2">
          ...
          <p className="text-[12px] font-medium leading-[140%] text-[#F8F7F3] md:text-sm lg:text-[16px]">
