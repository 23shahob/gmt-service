...
const DoctorsSection = () => {
  ...
  return (
    <div className="py-[60px] md:py-[120px] lg:py-[150px]">
      <div className="mx-auto max-w-[1440px] justify-between px-4 md:px-5 lg:flex lg:px-4">
        <div className="lg:w-2/5">
          <h3 className="mb-[10px] text-lg font-medium leading-[120%] md:mb-5 md:text-xl lg:mb-6 lg:text-3xl">
            Опытные сотрудники из производственных компаний
          </h3>
          <p className="mb-7 text-[12px] md:text-sm font-medium md:mb-10 lg:mb-0 lg:text-[16px] lg:leading-[140%]">
            ...
            <Slider {...settings} ref={sliderRef}>
              <div>
                <div className="grid grid-cols-1 gap-[10px] md:grid-cols-3">
                  <div className="rounded-[18px] border border-[#E5E2EE] md:col-span-2">
                    <div>
                      <img
                        src={Person1}
                        alt="Doctor Img"
                    ...
                    <div className="p-4 md:p-5">
                      <h3 className="mb-[2px] text-[12px] font-medium leading-[118%] md:text-sm lg:text-[16px] lg:leading-[140%]">
                        Константин Константинопольский
                      </h3>
                      <p className="text-[12px] font-normal text-[#7A7687] lg:text-sm">
                        Основатель компании
                      </p>
                    </div>
                  </div>
                  <div className="col-span-1 hidden flex-col gap-[10px] md:flex">
                    <div className="rounded-[18px] border border-[#E5E2EE]">
                      <img
                        src={Person2}
                        alt="Doctor Img"
                        className="h-auto w-full"
