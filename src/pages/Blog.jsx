      ...
      <div className="flex justify-between">
        ...
        <div className="relative block w-[236px] transition duration-700 ease-in-out lg:hidden">
          <div
            ...
            className="mb-2 flex cursor-pointer bg-[#F8F7F3] items-center justify-between rounded-[10px] border border-[#E5E2EE] px-4 py-3 transition duration-300 ease-in-out"
          >
          ...
          <ul
            className={`absolute flex-col gap-y-3 w-full bg-[#F8F7F3] rounded-[10px] border border-[#E5E2EE] p-4 transition duration-300 ease-in-out ${open ? "hidden" : "flex"}`}
          >
            <li>
